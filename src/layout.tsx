...
import { SideMenu, UserMenu } from "@adiba-banking-cloud/backoffice"
...
const sideMenuData : SideMenuProps = {
 ...
 const userMenuData : UsermenuProps = {
  name: "John Doe",
  ...
  sections: [
    {
      items: [
        {
          label: "items1",
          icon: { name: "ClipboardTick" },
          disclosure: true,
          callbackFn: () => alert("kds"),
        },
        {
          label: "items2",
          icon: { name: "ClipboardTick" },
...
export const layout: Partial<ComponentsState> = {
  ...
  DashboardContainer: ({ children }) => (
    <div>
      ...
      <div><Button c="red" color="black" onClick={()=>alert('foo')}>Foo</Button></div>
      <div>
      <Stack w={250} mih={400} bd={"1px solid #eee"} p={"md"} gap={0}>
